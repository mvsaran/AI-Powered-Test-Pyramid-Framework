...
describe('Checkout Flow Feature', { tags: ['@smoke', '@e2e'] }, () => {
    ...
    it('[REQ-CHECKOUT-001][TC-CHECKOUT-001] Verify checkout with valid details', { tags: ['@smoke', '@e2e', '@high'] }, () => {
    ...
    it('[REQ-CHECKOUT-001][TC-CHECKOUT-003] Verify confirmation message appears', { tags: ['@sanity', '@e2e', '@medium'] }, () => {
